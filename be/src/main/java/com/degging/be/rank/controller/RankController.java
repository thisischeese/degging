...
public class RankController {
    ...
    public BaseResponse<RankResponse> getTop5(){
        RankResponse result = rankService.getTop5();
    ...
    public BaseResponse<RankOnboardingResponse> get20ForOnboarding(){
        RankOnboardingResponse result = rankService.getOnboardingRanks();
        return BaseResponse.success(result);
    }
}
